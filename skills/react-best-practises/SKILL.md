...
Contains 47 rules across 8 categories, prioritized by impact to guide automated
...
- `rerender-no-use-effect` - Ban bare useEffect; use derived state / handlers /
  useMountEffect (nerdfish extension)
