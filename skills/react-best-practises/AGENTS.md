...
> generating, or refactoring React and Next.js code. Humans may also find it  
...
5. [Re-render Optimization](#5-re-render-optimization) — **MEDIUM**
   ...
   - 5.8 [No Bare useEffect](#58-no-bare-useeffect)
...
### 5.8 No Bare useEffect

**Impact: HIGH (Enforced by ESLint @nerdfish/conventions/no-use-effect)**
...
Full local rule: `agents/rules/quality-no-use-effect.md`.
